...
\title{Resume.}
\address{Address Line 1,\\Address Line 2,\\Address Line 3,}{4, 5.}
\phone{9876543210}
\email{me@onloop.net}
...
\quote{Application for the role of Software Development Engineer.}
% --------------------------------------
% CONTENT
% --------------------------------------
...
%%\pagebreak
\section{Education}
\cventry{Aug 2009 - May 2013}{B.E. Electrical and Electronics.}{Foo University, Foo}{}{}{Completed 6 out of 8 Semesters (3/4 years) - \textit{CGPA $7.2$/$10.0$}.}
% --------------------------------------
% INTERESTS HOBBIES
% --------------------------------------
